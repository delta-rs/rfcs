# Delta RFCs - [RFC Book](https://delta-rs.github.io/rfcs/)

[Delta RFCs]: #delta-rfcs

The "RFC" (request for comments) process is intended to provide a consistent
and controlled path for changes to Delta (such as new features) so that all
...
bit of a design process and produce a consensus among the Delta community and
the [sub-team]s.
...
Delta, Cargo, Crates.io, or the RFC process itself. What constitutes a
...
Some changes do not require an RFC:
  ...
  - Additions that strictly improve objective, numerical quality criteria
    ...
    more errors, etc.)
  - Additions only likely to be _noticed by_ other developers-of-delta,
    invisible to users-of-delta.
...
the Delta community's [sub-team] specific guidelines for:
...
In short, to get a major feature added to Delta, one must first get the RFC
merged into the RFC repository as a markdown file. At that point the RFC is
"active" and may be implemented with the goal of eventual inclusion into Delta.
  ...
  - The FCP lasts ten calendar days, so that it is open for at least 5 business
    ...
    e.g. in [Delta Ideas](https://github.com/orgs/delta-rs/discussions/categories/ideas). This way all
...
feature as a pull request to the Delta repo. Being "active" is not a rubber
...
it imply anything about whether a Delta developer has been assigned the task of
...
associated issue tracking its implementation in the Delta repository; thus that
associated issue can be assigned a priority via the triage process that the
team uses for all issues in the Delta repository.
...
at your option. Some parts of the repository are already licensed according to those terms. For more see [RFC 2044](https://github.com/delta-rs/rfcs/pull/2044) and its [tracking issue](https://github.com/delta-rs/delta/issues/43461).
...
[developer discussion forum]: https://github.com/orgs/delta-rs/discussions
[RFC repository]: https://github.com/delta-rs/rfcs
[sub-team]: https://github.com/orgs/delta-rs/teams/core-team
